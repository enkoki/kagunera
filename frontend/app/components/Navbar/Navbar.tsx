...
import SearchIcon from '@/app/assets/icons/SearchIcon' // Adjust path if needed
...
const Navbar = ({ isloggedin = false }) => {
    ...
    useEffect(() => {
        // If query is empty and we aren't on search page, do nothing
        ...
        const timer = setTimeout(() => {
            if (query.trim()) {
                ...
                // If on search page and clear input, show empty search
                router.push(`/search`);
            }
        }, 400);
